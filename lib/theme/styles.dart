...
TextStyle textStyleValorAbono = const TextStyle(
  color: Colors.teal,
  fontSize: 25.0,
  fontWeight: FontWeight.normal,
);

TextStyle textStyleMinus = const TextStyle(
...
const Color HeaderColorPrincipal = Colors.teal;
const Color ButtonColorPrincipal = Colors.teal;
...
TextStyle headingGrey1 = new TextStyle(
  color: Colors.grey,
  fontSize: 35.0,
  fontWeight: FontWeight.bold,
);

TextStyle headingGrey2 = new TextStyle(
  color: Colors.grey,
  fontSize: 35.0,
  fontWeight: FontWeight.bold,
);
...
class DialogUtils {
  static void ToasTed(String type, String msn) {
